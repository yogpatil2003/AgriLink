...
<head>
    ...
    <title>AgriLink - Forgot Password</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            padding: 0;
            min-height: 100vh;
            background-image: url('https://images.pexels.com/photos/96715/pexels-photo-96715.jpeg');
...
<body class="flex items-center justify-center min-h-screen relative">
    ...
    <div class="relative z-10 form-container glass">
        <div class="text-center header-anim">
            ...
            <p class="text-gray-300 text-sm mt-1">Password Recovery</p>
        </div>
        ...
        <!-- Reset Form -->
        <div id="resetForm" class="mt-8 space-y-6">
            <!-- Email Input -->
            ...
            <!-- Send Reset Link Button - Direct link to login -->
            <a href="{{ route('admin.login') }}" id="resetButton" class="w-full btn-3d flex justify-center items-center">
