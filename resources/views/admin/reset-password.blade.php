...
<head>
    ...
    <title>AgriLink - Reset Password</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            padding: 0;
            min-height: 100vh;
            background-image: url('https://images.wallpaperscraft.com/image/single/wheat_field_sunset_128125_1920x1080.jpg');
...
<body class="flex items-center justify-center min-h-screen relative">
    ...
    <div class="relative z-10 form-container glass">
        ...
        <!-- Reset Form -->
        <form id="resetForm" class="mt-8 space-y-6" action="{{ route('admin.password.update') }}" method="POST">
            @csrf
            ...
            <div class="input-group">
                <input id="email" name="email" type="email" class="placeholder-transparent" value="{{ $email ?? old('email') }}" placeholder=" " required readonly>
            ...
            <div class="input-group">
                ...
                <span class="input-icon toggle-password" data-target="password_confirmation">
                    <i class="fas fa-eye-slash"></i>
                </span>
            </div>

            <!-- Reset Button -->
            <button type="submit" id="resetButton" class="w-full btn-3d flex justify-center items-center">
        ...
        <div class="text-center mt-6">
            <p class="text-gray-300 text-sm">
                ...
                <a href="{{ route('admin.login') }}" class="login-link">Back to Login</a>
            </p>
        </div>
